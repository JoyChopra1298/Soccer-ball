...
#black wire camera without lights on 
...
ball_lower=[0,0,150] #white;
ball_upper=[179,50,255]     
...
opp1col_upper=[87,255,146]

opp2col_lower=[171,83,86]
opp2col_upper=[179,255,255] #orange
#camera blue
p=[70,220]# centerline 
q=[500,220]
x=[155,395] # my yellow goal line
y=[355,400]
'''
...
def move_To(bot_ctr,dest,jer_vect,pk_error):
    ...
    print cp
    d=dist(bot_ctr,dest)
    if cp==0:   # CHANGE ACCORDING TO NEED
        #print("move_forward")
        rm.move_forward()
        if d<=pk_error:
            stop()
